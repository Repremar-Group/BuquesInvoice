...
const IngresarFacturasMultipleEscala = ({ isLoggedIn }) => {
    ...
    const [escalas, setEscalas] = useState([]); // Estado para almacenar las escalas Asociados
    ...
    const handleSelectEscala = (escala) => {
        ...
        // Chequear si la escala ya está en el array
        setEscalasSeleccionadas((prevEscalas) => {
            const escalaYaSeleccionada = prevEscalas.some((e) => e.id === escala.id);
            if (!escalaYaSeleccionada) {
                return [...prevEscalas, escala];
            }
            return prevEscalas;
        });
    ...
    const handleEliminarEscala = (index) => {
        setEscalasSeleccionadas((prevEscalas) =>
            prevEscalas.filter((_, i) => i !== index)
        );
    };
    ...
    return (
        <div className="EmitirFacturaManual-container">
            <h2 className='titulo-estandar'>Ingreso de Facturas Multiple Escala</h2>
            <form method="POST" onSubmit={handleSubmitAgregarFactura} className='formulario-estandar'>
                ...
                <div className='primerafilaemisiondecomprobasntes'>
                    <div className='div-datos-comprobante'>
                        ...
                        <h3 className='subtitulo-estandar'>Escalas Asociadas</h3>
                        <div className='div-renglon-datos-facturasmanuales'>
                            <div>
                                <div>
                            ...
                            <div>{/* Tabla de Escalas */}
                                <table className="tabla-servicios">
                                    ...
                                    <tbody>
                                        {escalasSeleccionadas.map((escala, index) => (
                                            <tr key={index}>
                                                <td>{escala.buque}</td>
                                                <td>{escala.eta}</td>
                                                <td>
                                                    <button
                                                        ...
                                                        onClick={() => handleEliminarEscala(index)} // Llama a la función pasando el índice
                                                    >
                                                        ❌
                                                    </button>
                                                </td>
...
export default IngresarFacturasMultipleEscala